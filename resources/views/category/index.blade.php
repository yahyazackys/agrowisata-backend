            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-header justify-content-between d-flex">
                        ...
                        <a href="{{ route('add-category') }}" class="btn btn-sm btn-primary">Tambah</a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($data as $user)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $user->kategori->kategori_produk }}</td>
                                        <td>{{ $user->status }}</td>
                                        <td>
                                            <a href="{{ route('edit-category', $user->id) }}"
                                                class="btn btn-sm btn-success">Edit</a>
                                            <a href="{{ route('delete-category', $user->id) }}" class="btn btn-sm btn-danger"
